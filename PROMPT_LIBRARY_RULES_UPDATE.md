...
- Library name: JWebMP Typescript Client Library
- Repository URL / local path: https://github.com/JWebMP/TypescriptClient.git
- Org and project name: JWebMP / Typescript Client Library
- Rules Repository Location: rules/generative/frontend/jwebmp/typescript
- Short description: Exposes annotations and intefaces for JWebMP components to allow typescript generation from the component definition

- Type:
  - [ ] UI component library
  - [ ] Data/ORM
  - [ ] Service/Framework
  - [x] Other: JWebMP Typescript Client Library
